...
public class DbInitializer
{
    ...
    {
        // If there are any activities in db then we return 
        if (context.Activities.Any()) return;

        // If we don't have anything, we want to populate db
        ...
        // Entity framework is tracking if we updated the entities in memory
